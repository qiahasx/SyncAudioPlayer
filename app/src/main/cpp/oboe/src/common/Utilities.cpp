...
namespace oboe {
    ...
    const char *convertToText<Result>(Result returnCode) {
        switch (returnCode) {
            ...
            case Result::ErrorNoFreeHandles:
                return "ErrorNoFreeHandles";
            case Result::ErrorNoMemory:
                return "ErrorNoMemory";
            case Result::ErrorNull:
                return "ErrorNull";
            case Result::ErrorTimeout:
                return "ErrorTimeout";
            case Result::ErrorWouldBlock:
                return "ErrorWouldBlock";
            case Result::ErrorInvalidFormat:
                return "ErrorInvalidFormat";
            case Result::ErrorOutOfRange:
                return "ErrorOutOfRange";
            case Result::ErrorNoService:
                return "ErrorNoService";
            case Result::ErrorInvalidRate:
                return "ErrorInvalidRate";
            case Result::ErrorClosed:
                return "ErrorClosed";
            default:
    ...
    const char *convertToText<DataCallbackResult>(DataCallbackResult result) {
        switch (result) {
            case DataCallbackResult::Continue:
                return "Continue";
            case DataCallbackResult::Stop:
                return "Stop";
            default:
    ...
    const char *convertToText<StreamState>(StreamState state) {
        switch (state) {
            ...
            case StreamState::Disconnected:
                return "Disconnected";
            case StreamState::Flushed:
                return "Flushed";
            case StreamState::Flushing:
                return "Flushing";
    ...
    const char *convertToText<Usage>(Usage usage) {
        ...
        switch (usage) {
            ...
            case Usage::VoiceCommunicationSignalling:
                return "VoiceCommunicationSignalling";
            case Usage::Alarm:
                return "Alarm";
    ...
    const char *convertToText<InputPreset>(InputPreset inputPreset) {
        ...
        switch (inputPreset) {
            ...
            default:
                return "Unrecognized input preset";
        }
    }
    ...
    const char *convertToText<SessionId>(SessionId sessionId) {
        ...
        switch (sessionId) {
            case SessionId::None:
                return "None";
            case SessionId::Allocate:
                return "Allocate";
            default:
                return "Unrecognized session id";
        }
    }
    ...
    const char *convertToText<ChannelCount>(ChannelCount channelCount) {
        ...
        switch (channelCount) {
            ...
            case ChannelCount::Stereo:
                return "Stereo";
            default:
                return "Unrecognized channel count";
        }
    }

    template<>
    const char *convertToText<SampleRateConversionQuality>(
        ...
        switch (sampleRateConversionQuality) {
            ...
            case SampleRateConversionQuality::Best:
                return "Best";
            default:
                return "Unrecognized sample rate conversion quality";
        }
    }

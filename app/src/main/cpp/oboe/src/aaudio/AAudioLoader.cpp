...
namespace oboe {
    ...
    int AAudioLoader::open() {
        ...
        builder_setBufferCapacityInFrames = load_V_PBI(
        ...
        builder_setFramesPerDataCallback = load_V_PBI(
        ...
        if (getSdkVersion() >= __ANDROID_API_Q__) {
            builder_setAllowedCapturePolicy = load_V_PBI(
        ...
        if (getSdkVersion() >= __ANDROID_API_S_V2__) {
            ...
            builder_setIsContentSpatialized = load_V_PBO(
                    "AAudioStreamBuilder_setIsContentSpatialized");
            builder_setSpatializationBehavior = load_V_PBI(
...
// This code is in this .cpp file so it only gets tested once.
    ...
    static_assert((int32_t) StreamState::Uninitialized == AAUDIO_STREAM_STATE_UNINITIALIZED,
                  ERRMSG);
    ...
    static_assert((int32_t) DataCallbackResult::Continue == AAUDIO_CALLBACK_RESULT_CONTINUE,
                  ERRMSG);
...
// which is the first version to support Android Pie (API 28).
    ...
    static_assert((int32_t) Usage::NotificationRingtone == AAUDIO_USAGE_NOTIFICATION_RINGTONE,
                  ERRMSG);
    static_assert((int32_t) Usage::NotificationEvent == AAUDIO_USAGE_NOTIFICATION_EVENT, ERRMSG);
    static_assert((int32_t) Usage::AssistanceAccessibility == AAUDIO_USAGE_ASSISTANCE_ACCESSIBILITY,
                  ERRMSG);
    static_assert((int32_t) Usage::AssistanceNavigationGuidance
                  == AAUDIO_USAGE_ASSISTANCE_NAVIGATION_GUIDANCE, ERRMSG);
    static_assert((int32_t) Usage::AssistanceSonification == AAUDIO_USAGE_ASSISTANCE_SONIFICATION,
                  ERRMSG);
    ...
    static_assert((int32_t) InputPreset::VoiceRecognition == AAUDIO_INPUT_PRESET_VOICE_RECOGNITION,
                  ERRMSG);
...
// which is the first version to support Android SC_V2 (API 32).
    ...
    static_assert((uint32_t) ChannelMask::FrontLeftOfCenter == AAUDIO_CHANNEL_FRONT_LEFT_OF_CENTER,
                  ERRMSG);
    static_assert(
            (uint32_t) ChannelMask::FrontRightOfCenter == AAUDIO_CHANNEL_FRONT_RIGHT_OF_CENTER,
            ERRMSG);
    ...
    static_assert((uint32_t) ChannelMask::TopFrontCenter == AAUDIO_CHANNEL_TOP_FRONT_CENTER,
                  ERRMSG);
    ...
    static_assert((uint32_t) ChannelMask::BottomFrontLeft == AAUDIO_CHANNEL_BOTTOM_FRONT_LEFT,
                  ERRMSG);
    static_assert((uint32_t) ChannelMask::BottomFrontCenter == AAUDIO_CHANNEL_BOTTOM_FRONT_CENTER,
                  ERRMSG);
    static_assert((uint32_t) ChannelMask::BottomFrontRight == AAUDIO_CHANNEL_BOTTOM_FRONT_RIGHT,
                  ERRMSG);
    ...
    static_assert((uint32_t) ChannelMask::FrontWideRight == AAUDIO_CHANNEL_FRONT_WIDE_RIGHT,
                  ERRMSG);
    ...
    static_assert((int32_t) SpatializationBehavior::Auto == AAUDIO_SPATIALIZATION_BEHAVIOR_AUTO,
                  ERRMSG);
    static_assert((int32_t) SpatializationBehavior::Never == AAUDIO_SPATIALIZATION_BEHAVIOR_NEVER,
                  ERRMSG);

 ...
 */
    ...
    public:
        ...
        AudioStreamBuilder(const AudioStreamBase &audioStreamBase) : AudioStreamBase(
                audioStreamBase) {}
         ...
         */
        AudioStreamBuilder *
        setSpatializationBehavior(SpatializationBehavior spatializationBehavior) {
         ...
         */
        AudioStreamBuilder *
        setDataCallback(std::shared_ptr<AudioStreamDataCallback> sharedDataCallback) {
        ...
        */
         ...
         */
        AudioStreamBuilder *
        setErrorCallback(std::shared_ptr<AudioStreamErrorCallback> sharedErrorCallback) {
            // Use this raw pointer in the rest of the code to retain backwards compatibility.
